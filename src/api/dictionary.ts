...
export const dictionaryApi = {
  ...
  create: (type: DictionaryType, label: string, level?: 1 | 2) => api.post<DictionaryItem>('/api/admin/dictionary', { type, label, level }),
  update: (id: string, label: string, level?: 1 | 2) => api.put<DictionaryItem>(`/api/admin/dictionary/${id}`, { label, level }),
