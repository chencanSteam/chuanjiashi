...
② 点击事件卡片进入该事件的详情页（/m/archive/event/<年份>），可查看完整描述并上传、管理关联资料。
③ 「添加事件」和每条事件的编辑操作都打开弹窗，校验开始年份为 4 位数字、标题必填、结束年份不得早于开始年份，且不同事件的开始年份不可重复。
④ 保存后更新 cj_events_<档案id>，并同步写入 event-<档案id>-<年份> 详情缓存；新增保存成功后直接跳转到该事件详情页；编辑年份或标题时，已关联素材的阶段名同步更新。
