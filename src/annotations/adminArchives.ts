  ...
  items: [
    {
      ...
      target: '搜索与隐私筛选区',
      logic: `① 关键词（主人姓名、创建者）与隐私状态作为参数传给 adminArchiveApi.list，由 mock 后端过滤。
...
③ 隐私状态三档：私密 / 家人共享 / 公开，默认「全部」不过滤。`,
    },
    {
      ...
      target: '档案列表',
      logic: `① 每行展示主人姓名、创建者、素材计数（图/音/文分列）、隐私状态、完整度与创建时间。
...
③ 点击整行调用 adminArchiveApi.get(id) 打开详情抽屉，失败时 toast 报错。`,
    },
    {
      ...
      target: '档案详情抽屉',
      logic: `① 只读展示档案基础信息（主人姓名、创建者、完整度、创建时间）与素材列表（图片/音频/文档数量）。
② 管理端仅查看不修改：档案内容的增删改仍归创建者在前台操作。
③ 点击遮罩或右上角 × 关闭抽屉。`,
    },
  ],
};
