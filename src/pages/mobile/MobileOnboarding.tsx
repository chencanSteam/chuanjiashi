...
const defaultChapters: Chapter[] = [
  { title: '故里童年 · 初心萌芽', topics: ['童年记忆中最难忘的画面是什么？', '小时候家里的长辈对您影响最大的一句话是什么？', '学生时代的兴趣爱好是怎样形成的？'] },
  { title: '求学成长 · 岁月积淀', topics: ['求学期间遇到过哪些改变人生轨迹的老师或同学？', '为什么选择现在的职业方向？'] },
  { title: '择业入行 · 缘起初心', topics: ['职业生涯中最重要的转折点是什么？', '工作中最让您自豪的成就是什么？', '您如何看待事业与家庭的平衡？'] },
  { title: '事业深耕 · 厚绩成长', topics: ['人生中有哪些关键选择，后来改变了您的方向？', '遇到过哪些困难或低谷，您是怎样走出来的？'] },
  { title: '风雨磨砺 · 破局成长', topics: ['您和伴侣相识、相知的经历是怎样的？', '作为父母，您最希望孩子记住什么？', '家人曾经给过您哪些重要的支持？'] },
  { title: '行业感悟 · 职业修为', topics: ['您经历过哪些时代变化，对生活影响最大？', '那个年代的人和事，给您留下了什么印象？'] },
  { title: '家风人生 · 温情生活', topics: ['家里一直坚持的家风家训是什么？', '您最想把哪些生活经验传给下一代？'] },
  { title: '人生回望 · 未来愿景', topics: ['回顾一生，您最想对晚辈说的话是什么？', '如果用一个词总结自己的人生，您会选择哪个词？'] },
];
