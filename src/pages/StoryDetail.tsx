...
const storyData: Record<string, { tag: string; author: string; views: number; likes: number; content: string; date: string }> = {
  ...
  '爷爷讲的故事：童年的夏天': {
    ...
    likes: 15,
    date: '2026-06-10',
    content: '爷爷常说，他小时候的夏天没有电扇，更没有空调。傍晚一家人搬着竹床到院子里乘凉，奶奶摇着蒲扇赶蚊子，他和伙伴们追着萤火虫满村跑。井水冰过的西瓜，是他记忆里最甜的味道。那些夏夜的星星，他说，比现在城里看到的亮得多。',
  },
  '老宅的记忆：那个有葡萄架的院子': {
    tag: '故乡记忆',
    author: '张明远',
    ...
    likes: 11,
    date: '2026-06-08',
    content: '老家的院子不大，却有一架爷爷亲手搭的葡萄架。春天抽芽，夏天成荫，到了八月，一串串紫葡萄垂下来，孩子们踮着脚也够不着。爷爷总把最甜的第一串留给最小的孙女。后来老宅翻新，葡萄架拆了，但全家人说起"院子"，想到的还是那片绿荫。',
  },
  '家族年夜饭的传统': {
    tag: '家风故事',
    author: '李秀英',
    ...
    likes: 17,
    date: '2026-06-01',
    content: '我们家的年夜饭有三条雷打不动的规矩：桌上必须有一条整鱼，寓意年年有余；长辈不动筷，晚辈不能先吃；饭后全家围坐，听老人讲一段过去的故事。这些年孩子们天南海北，但每年除夕，这张桌子永远是满的。年夜饭吃的不是菜，是团圆。',
  },
};
