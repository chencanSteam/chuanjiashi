  ...
  keys.forEach((key) => {
    try {
      if (key.startsWith('cj_biography_chapters_')) {
        ...
        const newTitles = [
          '故里童年 · 初心萌芽', '求学成长 · 岁月积淀', '择业入行 · 缘起初心', '事业深耕 · 厚绩成长',
...
export function ensureDemoContent() {
  ...
  const zjgChapters = [
    ...
    { title: '事业深耕 · 厚绩成长', content: '<p>下岗后，我在县城租了一个不到 20 平方米的小门面，开了一家电维修部。从修电视、冰箱、洗衣机做起，后来也卖插座、电线和灯具，还带了好几个徒弟。</p><p>2005 年，我用这些年攒下的钱在县城买了一套 90 多平方米的房子，一家人从农村搬到了县城。</p>' },
